...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
            out.println("MEN\u00DA");
            out.println("1.- Agregar Contacto");
            out.println("2.- Existe contacto");
            out.println("3.- Busca contacto");
            out.println("4.- Eliminar Contactos");
            out.println("5.- Guardar contacto");
            out.println("6.- Listar registros");
            out.println("7.- Cargar registros");
            out.println("8.- Salir");
            do {
            ...
            out.println();
            if (vector.isEmpty() && opcion!=1 && opcion!=8) {
                pausar("No hay registros.\n");
                continue;
            }
            if (opcion<5) {
                contacto.setnombre(leer_cadena ("Ingrese el nombre del contacto"));
            ...
            case 1:
                ...
                break;
            case 3:
                out.println("Este registro busca los contactos");
...
class Contacto implements Comparable<Contacto> {
    ...
    public boolean equals(Object contacto) {
        return this==contacto || (contacto instanceof Contacto && nombre.equals(((Contacto)contacto).nombre));
    }
